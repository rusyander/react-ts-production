...
describe('ProfileSlice', () => {
  test('test set fetchArticlesById.pending', () => {
  ...
  test('test set fetchArticlesById.fulfilled', () => {
    const state: DeepPartial<ArticleDetailsSchema> = {
      isLoading: true,
    };
    expect(
  ...
  test('test set fetchArticlesById.rejected', () => {
    const state: DeepPartial<ArticleDetailsSchema> = {};
    expect(
      ArticleDetailsReducer(
        state as ArticleDetailsSchema,
        fetchArticlesById.rejected
      )
    ).toEqual({
      isLoading: false,
      error: undefined,
